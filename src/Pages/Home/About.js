...
const About = () => {
    return (
        <section className=" md:p-8 bg-[#2a2a2a] text-gray-100">
            <div className="container py-10 px-4 grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
                <div className="flex overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                    <div className="flex items-center justify-center px-4 bg-[#002f55] text-gray-100">
